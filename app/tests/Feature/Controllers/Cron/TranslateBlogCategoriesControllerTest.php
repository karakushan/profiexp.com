...
class TranslateBlogCategoriesControllerTest extends TestCase
{
    ...
    public function test_endpoint_rejects_without_token(): void
    {
        ...
        $response = $this->get('/translate-blog-categories');
    ...
    public function test_endpoint_rejects_with_wrong_token(): void
    {
        ...
        $response = $this->get('/translate-blog-categories?token=wrong_token');
    ...
    public function test_endpoint_accepts_with_valid_token(): void
    {
        ...
        $response = $this->get('/translate-blog-categories?token=secret123');
