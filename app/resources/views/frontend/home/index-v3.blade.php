...
@section('pageHeading')
    {{ !empty($seoInfo) && !empty($seoInfo->meta_title_home) ? $seoInfo->meta_title_home : __('Home') }}
@endsection
                ...
                <div class="col-xxl-7 col-xl-8 col-lg-10">
                    <div class="content">
                        <h1 class="title mb-20 color-white" data-aos="fade-up">
                            {{ !empty($heroSection->title) ? $heroSection->title : __('Are You Looking For A business?') }}</h1>
        ...
        <section class="category-area category-3 bg-primary-light pt-100 pb-70 has-grid">
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        <div class="section-title title-center mb-40" data-aos="fade-up">
                            <h2 class="title mb-15">{{ $catgorySecInfo ? $catgorySecInfo->title : __('CATEGORIES') }}</h2>
                            <p class="text mb-0">
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-md-4 col-sm-6 category-grid-item {{ $key >= 8 ? 'd-none' : '' }}">
                                        <a
                                            ...
                                            <div class="category-item radius-md text-center">
                                                ...
                                                <span
                                                    class="category-qty font-lg">{{ $category->distinct_listing_count }}</span>
                                            </div>
                                        </a>
                                    </div>
                                @endforeach
