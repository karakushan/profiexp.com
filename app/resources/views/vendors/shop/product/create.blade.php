            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="float-right d-inline-block">
                        <button type="button" class="btn btn-primary btn-sm mr-2 product-ai-field-btn" id="aiGenerateItemSeoBtn"
                            data-field="" data-lang=""
                            data-title="{{ __('AI Generate Product Content') }}">
                        ...
                        <div class="col-lg-8 offset-lg-2">
                            ...
                            <div class="ml-2">
                                ...
                                <button type="button" class="btn btn-sm btn-primary mt-3" data-ai-slider-open
                                    data-dropzone="#slider-dropzone"
                                    data-hidden-wrap="#slider-image-id"
                                    data-hidden-input-name="slider_images[]"
                                    data-endpoint="{{ route('vendor.ai.generate.slider.images') }}"
                                    data-upload-endpoint="{{ route('vendor.shop_management.upload_slider_image') }}"
                                    data-remove-endpoint="{{ route('vendor.shop_management.remove_slider_image') }}"
                                    data-remove-key="imageName"
                                    data-max-count="{{ $remaingSliderImage }}"
                                    data-count-default="3">
                                    <i class="fas fa-magic"></i> {{ __('Generate Slider Images') }}
                                </button>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="thumb-preview">
                                        <img src="{{ asset('assets/admin/img/noimage.jpg') }}" alt="..."
                                            class="uploaded-img" id="productFeaturedPreview">
                                    </div>
                                    <input type="hidden" name="ai_featured_image" id="productAiFeaturedImage">
                                    ...
                                    <div class="mt-3">
                                        ...
                                        <button type="button" class="btn btn-primary btn-sm ml-2"
                                            ...
                                            data-target="#productFeaturedPreview"
                                            data-hidden="#productAiFeaturedImage"
                                            data-file-input="input[name='featured_image']"
                                                        ...
                                                        <div class="col-lg-6">
                                                            <div
                                                                ...
                                                                <div class="d-flex justify-content-between align-items-center flex-wrap mb-2">
                                                                    ...
                                                                    <button type="button"
                                                                        class="btn btn-sm btn-primary product-ai-field-btn"
                                                                        data-field="title"
                                                                        data-lang="{{ $language->code }}"
                                                                        data-title="{{ __('AI Generate Title') }}">
                                                            ...
                                                            <div
                                                                ...
                                                                <div class="d-flex justify-content-between align-items-center flex-wrap mb-2">
                                                                    ...
                                                                    <button type="button"
                                                                        ...
                                                                        data-field="summary"
                                                                        data-lang="{{ $language->code }}"
                                                                        data-title="{{ __('AI Generate Summary') }}">
                                                                        <i class="fas fa-magic"></i> {{ __('Generate') }}
                                                                    </button>
                                                                </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-12">
                                                            <div
                                                                class="form-group {{ $language->direction == 1 ? 'rtl text-right' : '' }}">
                                                                <div class="d-flex justify-content-between align-items-center flex-wrap mb-2">
                                                                    <label class="mb-0">{{ __('Content') . '*' }}</label>
                                                                    <button type="button"
                                                                        class="btn btn-sm btn-primary product-ai-field-btn"
                                                                        data-field="description"
                                                                        data-lang="{{ $language->code }}"
                                                                        data-title="{{ __('AI Generate Content') }}">
                                                                        <i class="fas fa-magic"></i> {{ __('Generate') }}
                                                                    </button>
                                                                </div>
                                                            ...
                                                            <div
                                                                ...
                                                                <div class="d-flex justify-content-between align-items-center flex-wrap mb-2">
                                                                    ...
                                                                    <button type="button"
                                                                        ...
                                                                        data-lang="{{ $language->code }}"
                                                                        data-title="{{ __('AI Generate Meta Keywords') }}">
                                                                        <i class="fas fa-magic"></i> {{ __('Generate') }}
                                                                    </button>
                                                                </div>
                                                            ...
                                                            <div
                                                                ...
                                                                <div class="d-flex justify-content-between align-items-center flex-wrap mb-2">
                                                                    ...
                                                                    <button type="button"
                                                                        ...
                                                                        data-lang="{{ $language->code }}"
                                                                        data-title="{{ __('AI Generate Meta Description') }}">
                                                                        <i class="fas fa-magic"></i> {{ __('Generate') }}
                                                                    </button>
                                                                </div>
...
@section('script')
    <script>
        ...
        const productAiLanguages = {!! $languages->map(function ($language) {
    ...
    <script>
        ...
        AiFormGenerator.init({
            ...
            outputs: function () {
                ...
                (productAiLanguages || []).forEach(function (language) {
                    const code = language.code;
                    outputs[code + '_title'] = '[name="' + code + '_title"]';
                    outputs[code + '_summary'] = '[name="' + code + '_summary"]';
                    outputs[code + '_description'] = '[name="' + code + '_content"]';
