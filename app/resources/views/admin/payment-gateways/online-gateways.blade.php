...
@section('content')
    ...
    <div class="row">
        ...
        {{-- WayforPay Information --}}
        <div class="col-lg-4">
            <div class="card">
                <form action="{{ route('admin.payment_gateways.update_wayforpay_info') }}" method="post">
                    @csrf
                    <div class="card-header">
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="card-title">{{ __('WayforPay') }}</div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="form-group">
                                    <label>{{ __('WayforPay Status') }}</label>
                                    <div class="selectgroup w-100">
                                        <label class="selectgroup-item">
                                            <input type="radio" name="wayforpay_status" value="1"
                                                class="selectgroup-input"
                                                {{ $wayforpay->status == 1 ? 'checked' : '' }}>
                                            <span class="selectgroup-button">{{ __('Active') }}</span>
                                        </label>
                                        <label class="selectgroup-item">
                                            <input type="radio" name="wayforpay_status" value="0"
                                                class="selectgroup-input"
                                                {{ $wayforpay->status == 0 ? 'checked' : '' }}>
                                            <span class="selectgroup-button">{{ __('Deactive') }}</span>
                                        </label>
                                    </div>
                                    @if ($errors->has('wayforpay_status'))
                                        <p class="mt-1 mb-0 text-danger">{{ $errors->first('wayforpay_status') }}</p>
                                    @endif
                                </div>

                                @php $wayforpayInfo = json_decode($wayforpay->information, true); @endphp

                                <div class="form-group">
                                    <label>{{ __('WayforPay Test Mode') }}</label>
                                    <div class="selectgroup w-100">
                                        <label class="selectgroup-item">
                                            <input type="radio" name="wayforpay_sandbox_status" value="1"
                                                class="selectgroup-input"
                                                {{ $wayforpayInfo['sandbox_status'] == 1 ? 'checked' : '' }}>
                                            <span class="selectgroup-button">{{ __('Active') }}</span>
                                        </label>
                                        <label class="selectgroup-item">
                                            <input type="radio" name="wayforpay_sandbox_status" value="0"
                                                class="selectgroup-input"
                                                {{ $wayforpayInfo['sandbox_status'] == 0 ? 'checked' : '' }}>
                                            <span class="selectgroup-button">{{ __('Deactive') }}</span>
                                        </label>
                                    </div>
                                    @if ($errors->has('wayforpay_sandbox_status'))
                                        <p class="mt-1 mb-0 text-danger">{{ $errors->first('wayforpay_sandbox_status') }}</p>
                                    @endif
                                </div>

                                <h5 class="mt-3 mb-2 text-secondary">{{ __('1. Accept Payment (Purchase)') }}</h5>

                                <div class="form-group">
                                    <label>{{ __('Merchant Account') }}</label>
                                    <input type="text" class="form-control" name="wayforpay_api_merchant_account"
                                        value="{{ @$wayforpayInfo['api']['merchant_account'] }}">
                                    @if ($errors->has('wayforpay_api_merchant_account'))
                                        <p class="mt-1 mb-0 text-danger">{{ $errors->first('wayforpay_api_merchant_account') }}</p>
                                    @endif
                                    <p class="text-warning mt-1">{{ __('Test merchant:') }} test_merch_n1</p>
                                </div>

                                <div class="form-group">
                                    <label>{{ __('Secret Key') }}</label>
                                    <input type="text" class="form-control" name="wayforpay_api_secret_key"
                                        value="{{ @$wayforpayInfo['api']['secret_key'] }}">
                                    @if ($errors->has('wayforpay_api_secret_key'))
                                        <p class="mt-1 mb-0 text-danger">{{ $errors->first('wayforpay_api_secret_key') }}</p>
                                    @endif
                                    <p class="text-warning mt-1">{{ __('Test secret:') }} flk3409refn54t54t*FNJRET</p>
                                </div>

                                <h5 class="mt-3 mb-2 text-secondary">{{ __('2. P2P Card Transfer') }}</h5>

                                <div class="form-group">
                                    <label>{{ __('Merchant Account') }}</label>
                                    <input type="text" class="form-control" name="wayforpay_p2p_cardtransfer_merchant_account"
                                        value="{{ @$wayforpayInfo['p2p_cardtransfer']['merchant_account'] }}">
                                    <p class="text-warning mt-1">{{ __('Test merchant:') }} test_merch_p2p</p>
                                </div>

                                <h5 class="mt-3 mb-2 text-secondary">{{ __('3. P2P Credit') }}</h5>

                                <div class="form-group">
                                    <label>{{ __('Merchant Account') }}</label>
                                    <input type="text" class="form-control" name="wayforpay_p2p_credit_merchant_account"
                                        value="{{ @$wayforpayInfo['p2p_credit']['merchant_account'] }}">
                                    <p class="text-warning mt-1">{{ __('Test merchant:') }} p2p_credit</p>
                                </div>
                            </div>
                        </div>
                    </div>
