...
class BlogCategoryTranslationService
{
    ...
    public function translate(BlogCategoryContent $source, string $targetLangCode, string $targetLangName): array
    {
    ...
    public function buildTranslationPrompt(BlogCategoryContent $source, string $targetLangName): string
    {
        $fields = [
            'name' => $source->name ?? '',
            'slug' => $source->slug ?? '',
