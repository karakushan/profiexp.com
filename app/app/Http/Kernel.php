...
class Kernel extends HttpKernel
{
  ...
  protected $middleware = [
    ...
    \App\Http\Middleware\SetDefaultLanguagePrefix::class,
  ];
  ...
  protected $routeMiddleware = [
    ...
    'aiQuotaWarning' => \App\Http\Middleware\AiQuotaWarning::class,
    'api.lang' => \App\Http\Middleware\SetApiLocale::class,
  ];
}
