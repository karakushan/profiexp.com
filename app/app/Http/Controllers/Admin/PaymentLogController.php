    ...
    public function update(Request $request)
    {
        ...
        if ($request->status === "1") {
            ...
            VendorNotificationService::send(
                $vendor,
                'vendor_package_activated',
                'Package activated',
                'Your package "' . $package->title . '" has been activated successfully.',
                [
            ...
            VendorNotificationService::send(
                $vendor,
                'vendor_package_payment_rejected',
                'Package payment rejected',
                'Your package payment request for "' . $package->title . '" was rejected.',
                [
                    'package_id' => $package->id,
                    'membership_id' => $membership->id,
                ]
