...
class WithdrawController extends Controller
{
    ...
    public function approve($id)
    {
        ...
        VendorNotificationService::send(
            $seller,
            'vendor_withdraw_status_updated',
            'Withdraw approved',
            'Your withdraw request #' . $withdraw->withdraw_id . ' has been approved.',
            [
    ...
    public function decline($id)
    {
        ...
        VendorNotificationService::send(
            ...
            'vendor_withdraw_status_updated',
            'Withdraw rejected',
            'Your withdraw request #' . $withdraw->withdraw_id . ' was rejected by admin.',
            [
                'withdraw_id' => $withdraw->id,
                'status' => 2,
            ]
