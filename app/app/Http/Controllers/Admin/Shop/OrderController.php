...
class OrderController extends Controller
{
    ...
    public function updatePaymentStatus(Request $request, $id)
    {
        ...
        $this->notifyOrderVendors(
            $order,
            'vendor_product_order_payment_status_updated',
            'Order payment updated',
            'Payment status for order #' . $order->order_number . ' is now ' . $order->payment_status . '.'
        );
    ...
    public function updateOrderStatus(Request $request, $id)
    {
        ...
        $this->notifyOrderVendors(
            $order,
            'vendor_product_order_status_updated',
            'Order status updated',
            'Order #' . $order->order_number . ' is now ' . $order->order_status . '.'
        );
    ...
    private function notifyOrderVendors(ProductOrder $order, string $type, string $title, string $message): void
    {
        $vendorIds = $order->item()
