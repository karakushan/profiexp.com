...
class BasicController extends Controller
{
    ...
    public function updateOpenAI(Request $request)
    {
        ...
        DB::table('basic_settings')->updateOrInsert(
            ...
            [
                ...
                'openai_text_model' => $request->openai_text_model,
                'openai_image_model' => $request->openai_image_model
            ]
        );
        ...
        Session::flash('success', __('OpenAI info updated successfully') . '!');
    ...
    // public function updatePollinations(Request $request)
    // {
    //     $rules = [
    //         'pollinations_secret_key' => 'nullable|string|max:255',
    //         'pollinations_text_model' => 'nullable|string|max:255',
    //         'pollinations_image_model' => 'nullable|string|max:255',
    //     ];
    ...
    //         ['uniqid' => 12345],
    //         [
    //             'pollinations_secret_key' => $request->pollinations_secret_key,
    //             'pollinations_text_model' => $request->pollinations_text_model,
    //             'pollinations_image_model' => $request->pollinations_image_model
    //         ]
    //     );
    ...
    //     Session::flash('success', __('Pollinations info updated successfully') . '!');
