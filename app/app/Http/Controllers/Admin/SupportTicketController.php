...
class SupportTicketController extends Controller
{
    ...
    public function ticketreply(Request $request, $id)
    {
        ...
        VendorNotificationService::send(
            ...
            'New support reply',
            'You received a new reply on support ticket #' . $id . '.',
            [
                'ticket_id' => $id,
            ]
        );
    ...
    public function ticket_closed($id)
    {
        ...
        VendorNotificationService::send(
            $ticket?->vendor,
            'vendor_support_ticket_status_updated',
            'Ticket closed',
    ...
    public function assign_stuff(Request $request, $id)
    {
        if($request->admin_id){
            ...
            $support_ticket->save();
            VendorNotificationService::send(
                $support_ticket?->vendor,
                'vendor_support_ticket_assigned',
                'Ticket assigned',
                'A support staff member has been assigned to your ticket #' . $id . '.',
                [
                    'ticket_id' => $id,
