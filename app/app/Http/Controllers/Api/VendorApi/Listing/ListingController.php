  ...
  public function store(ListingStoreRequest $request)
  {
    if ($request->can_listing_add == 2) {
      ...
      foreach ($languages as $language) {
        ...
        $listingContent->slug = unique_listing_slug($request[$language->code . '_title'], $language->id);
...
// Countries list
  ...
  public function apiStore(Request $request)
  {
    ...
    foreach ($languages as $language) {
      ...
      $listingContent->slug          = unique_listing_slug($request->input($code . '_title', ''), $language->id);
  ...
  public function apiUpdate(Request $request, $id)
  {
    ...
    foreach ($languages as $language) {
      ...
      $listingContent->slug             = unique_listing_slug($request->input($code . '_title', ''), $language->id, $listingContent->id);
